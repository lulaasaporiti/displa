...
@Component({
  selector: 'app-recibo-proveedor',
  templateUrl: './recibo.component.html',
  styleUrls: ['./recibo.component.css']
})
export class ReciboProveedorComponent implements OnInit {
  ...
  ngOnInit() {
    combineLatest([
      ...
      this.gastos = r[1];
      this.modelFactura.IdTipoComprobante = r[2].find(t => t.Descripcion == "Factura").Id;
